            ...
            <main className="flex-1 lg:ml-80 transition-all duration-700">
                ...
                <header className="fixed top-0 left-0 lg:left-80 right-0 z-40 bg-[var(--apple-bg)]/80 backdrop-blur-2xl border-b border-[var(--apple-border)] px-4 lg:px-12 py-3 lg:py-6 flex items-center justify-between transition-all duration-500 animate-apple-in">
                    ...
                    <div className="flex items-center gap-3 lg:gap-6">
                        ...
                        <button
                            onClick={toggleTheme}
                            className="w-10 h-10 lg:w-12 lg:h-12 rounded-2xl apple-glass flex items-center justify-center text-[var(--istpet-gold)] hover:scale-110 transition-all duration-500 shadow-xl"
                        ...
                        <button className="relative w-10 h-10 lg:w-12 lg:h-12 rounded-2xl apple-glass flex items-center justify-center text-[var(--apple-text-sub)] hover:text-[var(--apple-primary)] transition-all duration-500 shadow-xl group">
                        ...
                        <div className={`w-10 h-10 lg:w-12 lg:h-12 rounded-2xl lg:rounded-3xl shadow-xl border-2 lg:border-4 border-white transition-all duration-700 bg-gradient-to-tr ${theme === 'dark' ? 'from-amber-500 to-amber-200' : 'from-[var(--istpet-navy)] to-slate-700'}`}></div>
                    </div>
                </header>
