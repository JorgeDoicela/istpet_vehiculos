                ...
                <header className="mb-8 lg:mb-16 flex items-center justify-between">
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex flex-col">
                            <h2 className="text-2xl lg:text-4xl font-black tracking-tighter text-[var(--istpet-navy)] leading-none">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="w-12 h-12 rounded-3xl bg-gradient-to-tr from-[var(--istpet-navy)] to-slate-700 shadow-xl border-4 border-white"></div>
                    </div>
                </header>
