...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.129-1.125V13.5m-14.717-1.5h11.97M17.25 3.375H6.75c-.621 0-1.125.504-1.125 1.125v13.125m11.25-14.25c.621 0 1.125.504 1.125 1.125v13.125" />
                </svg>
            )
        },
        {
