    ...
    return (
        ...
        >
            <div className="flex items-center gap-5">
                ...
                <div className={`p-2 lg:p-3 rounded-xl lg:rounded-2xl transition-all duration-500 ${isSelected ? 'bg-[var(--apple-primary)] text-white shadow-lg shadow-blue-500/30' : 'bg-[var(--apple-bg)] text-[var(--apple-text-sub)] group-hover:bg-[var(--apple-primary)]/20 group-hover:text-[var(--apple-primary)]'}`}>
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-2">
                        <span className={`text-2xl lg:text-4xl font-black tracking-tighter transition-colors ${isSelected ? 'text-[var(--apple-primary)]' : 'text-[var(--apple-text-main)]'}`}>
