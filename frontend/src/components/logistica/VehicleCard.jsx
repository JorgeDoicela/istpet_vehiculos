    ...
    return (
        <div
            ...
            className={`
                ...
                flex flex-col items-center justify-center min-h-[65px] lg:min-h-[80px]
                ${!isOperativo
        ...
        >
            ...
            {/* Icono de Vehículo */}
            <div className={`mb-0.5 transition-all duration-500 ${isSelected ? 'text-[var(--istpet-gold)] scale-110' : 'text-[var(--apple-text-sub)] group-hover:text-[var(--istpet-gold)]'}`}>
                <svg className="h-3 w-3 lg:h-4 lg:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
            ...
            <div className="text-center">
                <div className="flex items-center justify-center gap-1">
                    <span className={`text-base lg:text-lg font-black tracking-tighter transition-colors ${isSelected ? 'text-[var(--istpet-gold)]' : 'text-[var(--apple-text-main)]'}`}>
                        #{numero}
                    </span>
                </div>
